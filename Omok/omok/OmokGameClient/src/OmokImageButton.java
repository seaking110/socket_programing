 ...
 */
public class OmokImageButton extends JButton {
	 ...
	 */
	public OmokImageButton(String imageUrl, String text) {
		super();
		currentImage = new ImageIcon(imageUrl).getImage();
	 ...
	 */
	public OmokImageButton(String imageUrl, String text, String rolloverImageUrl) {
		this(imageUrl, text);
		rolloverImage = new ImageIcon(rolloverImageUrl).getImage();
	}
	...
	public OmokImageButton(String imageUrl, String text, 
		...
		hitImage = new ImageIcon(hitImageUrl).getImage();
	}
...
//		System.out.println("BUTTON");
	...
	public void setImage(String imgUrl) {
		currentImage = new ImageIcon(imgUrl).getImage();
	}
